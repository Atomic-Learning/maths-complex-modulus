Every complex number can be assigned a size, or magnitude, that measures how far it sits from the origin. This magnitude is called the *modulus* (or absolute value), and it is always a non-negative real number.

# Definition

For a complex number $z = x + iy$, the **modulus** is written $|z|$ and is defined as:
